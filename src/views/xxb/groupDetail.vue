        ...
        <div class="dataDetail floatL">
          ...
          <p class="groupButton" style="text-align:left;">
            <router-link to="/buylist">
              <button
                style="outline:none;border:2px solid #d33a31;padding:15px 45px;margin-right:20px;background-color:white;color:#d33a31;font-size:19px;display:none"
              >
                立即购买
              </button>
            </router-link>
